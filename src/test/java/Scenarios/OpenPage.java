...
public class OpenPage {
    ...
    Elements page;
    FruitAndVegMenuElements fruitAndVegElement;
    ...
    public void setUp() throws Exception{
        ...
        fruitAndVegElement = new FruitAndVegMenuElements(driver);
    ...
    protected void initJqueryPointVegMenuElements(){
        if(!(Boolean) FruitAndVegMenuElements.js.executeScript("return (typeof jQuery != \"undefined\")")) {
            FruitAndVegMenuElements.js.executeScript(
            ...
            Function<WebDriver, Boolean> jQueryAvailable = WebDriver -> (
                    (Boolean) FruitAndVegMenuElements.js.executeScript("return (typeof jQuery != \"undefined\")")
            );
